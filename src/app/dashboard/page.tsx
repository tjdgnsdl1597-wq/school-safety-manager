    ...
    <div className="min-h-screen bg-gray-50 overflow-x-hidden">
      <div className="max-w-full mx-auto px-2 sm:px-4 lg:px-8 py-2 sm:py-4">
        <div className="flex flex-col lg:grid lg:grid-cols-7 gap-4 lg:gap-8">
            ...
            {/* 담당자 정보 - 모바일에서 첫번째 */}
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4 order-1 lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 order-2 lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 order-4 lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 order-5 lg:col-span-2">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 order-3 lg:col-span-5">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 order-6 lg:col-span-5">
